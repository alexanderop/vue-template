...
Build a brain snapshot: `sh .agents/skills/meditate/scripts/snapshot.sh docs/ /tmp/brain-snapshot-ruminate.md`. Pass the snapshot path to each analysis agent. This avoids loading the full brain into the ruminate orchestrator's context.
...
- Update `docs/index.md` after all changes
