...
1. **Read `docs/index.md`** to understand what notes already exist
...
5. **Update `docs/index.md`** if any brain files were added or removed
...
Before routing a learning to `docs/`, ask: can this be a lint rule, script, metadata flag, or runtime check? If yes, encode it structurally and skip the brain note. See `docs/principles/encode-lessons-in-structure.md`.
